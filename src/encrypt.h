...
enum encrypttype { ENCRYPT_NONE = 0, ENCRYPT_CAESAR, ENCRYPT_VIGENERE, ENCRYPT_ROT13, ENCRYPT_ROT47, ENCRYPT_ATBASH, ENCRYPT_SUBSTITUTION, ENCRYPT_PAIRWISE_SUBSTITUTION, ENCRYPT_ENIGMA_SINGLE_ROTOR, ENCRYPT_MAX_VAL };
